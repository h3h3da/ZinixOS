...
00007C06  E80300            call word 0x7c0c
00007C09  E9FDFF            jmp word 0x7c09
00007C0C  B81F7C            mov ax,0x7c1f
00007C0F  89C5              mov bp,ax
00007C11  B91B00            mov cx,0x1b
00007C14  B80113            mov ax,0x1301
00007C17  BB0C00            mov bx,0xc
00007C1A  B200              mov dl,0x0
00007C1C  CD10              int 0x10
00007C1E  C3                ret
00007C1F  48                dec ax
00007C20  656C              gs insb
00007C22  6C                insb
00007C23  6F                outsw
00007C24  2C20              sub al,0x20
00007C26  7765              ja 0x7c8d
00007C28  6C                insb
00007C29  636F6D            arpl [bx+0x6d],bp
00007C2C  6520746F          and [gs:si+0x6f],dh
00007C30  205A69            and [bp+si+0x69],bl
00007C33  6E                outsb
00007C34  6978204F53        imul di,[bx+si+0x20],word 0x534f
00007C39  2100              and [bx+si],ax
